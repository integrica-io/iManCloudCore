...
func GetLibraryGroups(ctx context.Context, client *client.Client, libraryId string, groupId string, options *GetLibraryGroupsOptions)(GetLibraryGroupsOutput, error){
	var data GetLibraryGroupsOutput
	endpoint := client.BaseUrl.JoinPath("work","api","v2","customers",client.TokenCfg.CustomerId, "libraries", libraryId, "groups")
...
type GetLibraryGroupsOutput struct {
	Data []struct {
...
type GetLibraryGroupsOptions struct { 
