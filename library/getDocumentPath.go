...
func GetDocumentPath(ctx context.Context, client *client.Client, libraryId string, documentId string) (GetDocumentPathOutput, error) {
	var data GetDocumentPathOutput
	endpoint := client.BaseUrl.JoinPath("work", "api", "v2", "customers", client.TokenCfg.CustomerId, "libraries", libraryId, "documents", fmt.Sprintf("%s!%s", libraryId, documentId), "path")
