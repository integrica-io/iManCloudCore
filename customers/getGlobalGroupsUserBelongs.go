...
func GetGlobalGroupsUserBelongs(ctx context.Context, client *internal.Client, userId string, options *GetGlobalGroupsUserBelongsOptions)(GetGlobalGroupsUserBelongsOutput, error){
